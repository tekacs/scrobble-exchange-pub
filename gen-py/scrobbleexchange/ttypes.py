...
class ArtistHistoryValue(object):
  """
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('ArtistHistoryValue')
    if self.date is not None:
      oprot.writeFieldBegin('date', TType.I32, 1)
...
class ArtistHistory(object):
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'histvalues', (TType.STRUCT,(ArtistHistoryValue, ArtistHistoryValue.thrift_spec)), None, ), # 1
  ...
  def write(self, oprot):
    ...
    if self.histvalues is not None:
      ...
      oprot.writeListBegin(TType.STRUCT, len(self.histvalues))
      for iter15 in self.histvalues:
        iter15.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
...
class UserData(object):
  ...
  thrift_spec = (
    ...
    (3, TType.LIST, 'curstocks', (TType.STRUCT,(Artist, Artist.thrift_spec)), None, ), # 3
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i39 in xrange(_size35):
            _elem40 = Trophy()
            _elem40.read(iprot)
            self.curtrophies.append(_elem40)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
  ...
  def write(self, oprot):
    ...
    if self.curtrophies is not None:
      ...
      for iter43 in self.curtrophies:
        iter43.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()

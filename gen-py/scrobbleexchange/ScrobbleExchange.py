...
class Iface(object):
  ...
  def buyArtist(self, artist, user, value):
    """
  ...
  def sellArtist(self, artist, user, value):
    """
...
class Client(Iface):
  ...
  def buyArtist(self, artist, user, value):
    ...
    Parameters:
     ...
     - value
    """
    self.send_buyArtist(artist, user, value)
    return self.recv_buyArtist()

  def send_buyArtist(self, artist, user, value):
  ...
  def sellArtist(self, artist, user, value):
    ...
    Parameters:
     ...
     - value
    """
    self.send_sellArtist(artist, user, value)
    return self.recv_sellArtist()

  def send_sellArtist(self, artist, user, value):
...
class Processor(Iface, TProcessor):
  ...
  def process_buyArtist(self, seqid, iprot, oprot):
    ...
    result = buyArtist_result()
    try:
      result.success = self._handler.buyArtist(args.artist, args.user, args.value)
  ...
  def process_sellArtist(self, seqid, iprot, oprot):
    ...
    result = sellArtist_result()
    try:
      result.success = self._handler.sellArtist(args.artist, args.user, args.value)
    except TransactionException as transexp:
      result.transexp = transexp
    except UserException as userexp:
      result.userexp = userexp
...
class buyArtist_args(object):
  ...
  def __init__(self, artist=None, user=None, value=None,):
    self.artist = artist
    self.user = user
    self.value = value
